...
class Captcha:
	def __init__(self):
		...
		self.chars = ''.join((numbers))  

	def create_validate_code(self,size=(100, 30),  
							 mode="RGB",  
	...
	def getCode(self):
		code_img,strs = self.create_validate_code()
		buf = cStringIO.StringIO()
		code_img.save(buf, 'JPEG',quality=70)
		return strs, base64.b64encode(buf.getvalue())

if __name__ == '__main__':
	captcha = Captcha()
	print captcha.getCode()
